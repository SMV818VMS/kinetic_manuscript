...
% Inject something here about the distributions of NAC, Escape, and
% Unscrunching and Abortive RNA Release (UAR).

\begin{figure}
	\begin{center}
      \includegraphics[scale=0.8]{../figures/parameter_estimation_distributions_1.pdf}
	\end{center}
...
\begin{figure}
	\begin{center}
      \includegraphics[scale=0.8]{../figures/parameter_estimation_distributions_2.pdf}
	\end{center}
    \caption{
