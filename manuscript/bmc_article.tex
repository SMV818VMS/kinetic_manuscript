...
\begin{figure}[h!]
    \begin{center}
      %\includegraphics{../illustrations/model_and_rates_mini}[scale=0.2]
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
      %\includegraphics{../illustrations/concept.pdf}[scale=0.2]
    \end{center}
...
\begin{figure}[h!]
\begin{center}
      %\includegraphics{../figures/Fig3}[scale=0.2]
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
      %\includegraphics{../figures/Fig4}[scale=0.2]
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
      %\includegraphics{../figures/Fig6}[scale=0.2]
    \end{center}
    \caption{
...
\begin{figure}[h!]
    \begin{center}
        %\includegraphics{../figures/Fig7}[scale=0.2]
    \end{center}
